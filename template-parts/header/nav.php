...
$header_menu_id = $menu_class->get_menu_id('digital-header-menu');//menu id
$header_menus = wp_get_nav_menu_items( $header_menu_id );//all menu items(parents, childs) as an array
